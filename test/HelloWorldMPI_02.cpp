...
{
    int rank, size;//Rank: Para distintos procesos con lo q se trabaja, Size: Cantidad de procesos

    MPI_Init(&argc, &argv); // Inicializacion del entorno MPI// init: que parte voy a paralelizar
